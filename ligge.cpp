...
int Ligge_Saar::check_current_pos (sensors_event_t a) {
...
bool Ligge_Saar::right_side (sensors_event_t a) {
...
bool Ligge_Saar::left_side (sensors_event_t a){
...
bool Ligge_Saar::back_side (sensors_event_t a){ 
...
bool Ligge_Saar::sitting (sensors_event_t a){
...
void Ligge_Saar::send_pos () {
  Serial.print("pos "); 
  Serial.println(current_pos);
}

void Ligge_Saar::send_alarm () {
  Serial.println(1);
}